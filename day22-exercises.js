...
// document.body.insertBefore(divEl, document.querySelector("#root"))
// divEl.classList.add("container")

// document.querySelector(".container").innerHTML = `<h1>Number Generator</h1><p>30DaysOfJavaScript:DOM Day 2</p>`
// for (let i = 0; i <= 101; i++) {
//     const divEl = document.createElement("div");
//     divEl.innerHTML = i;
...
// <h2>Total Number of Countrie: ${countries.length}</h2>
...
// 	const divEl = document.createElement("div");
// 	divEl.innerHTML = `${countries[i].name}`
// 	document.querySelector("#root").appendChild(divEl)
